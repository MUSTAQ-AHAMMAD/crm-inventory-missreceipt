...
export default function MiscReceiptPage() {
  ...
  const { data: progressData } = useQuery({
    queryKey: ['miscReceiptProgress', activeUploadId],
    queryFn: () => api.get(`/misc-receipt/uploads/${activeUploadId}/progress`).then((r) => r.data),
        ...
        {activeUploadId && progressData && (
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 space-y-3">
            <p className="font-semibold text-purple-700 flex items-center gap-2">
              <Spinner size="sm" /> Processing Miscellaneous Receipt Requests...
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              ...
              <div className="bg-white rounded p-2 text-center">
                <p className="text-xs text-purple-600 uppercase tracking-wide">In Progress</p>
                <p className="text-xl font-bold text-purple-600">{processed} / {total}</p>
              </div>
            </div>
            ...
            {progressData.responseLog && (
              <details className="bg-white rounded-lg p-3">
                <summary className="text-sm font-medium text-purple-600 hover:underline cursor-pointer">
