              ...
              <div key={index} className="bg-gray-50 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      ...
                      {result.payloadTotals?.[index] != null && (
                        <> | <span className="font-semibold text-gray-800">Total: SAR {Number(result.payloadTotals[index]).toLocaleString('en-SA', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></>
                      )}
                    </p>
                  </div>
                  <button
                ...
                <div className="mt-3 p-3 bg-white rounded border border-gray-200">
                  ...
                  <div className="mt-2 pt-2 border-t border-gray-200 text-xs flex justify-between font-semibold text-gray-700">
                    ...
                    <span className="font-mono">SAR {Number(result.payloadTotals?.[index] ?? 0).toLocaleString('en-SA', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                </div>
